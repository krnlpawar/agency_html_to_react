  ...
  return (
	...
	<div className="row">
		<div className="col span_1_of_4 box">
			<img src="resources/img/1.jpg" alt="Kate Upton" className="team-member"/>
			<h3>Kate Upton</h3>
		...
		<div className="col span_1_of_4 box">
			<img src="resources/img/2.jpg" alt="OLIVIA WILDE" className="team-member"/>
			<h3>OLIVIA WILDE</h3>
		...
		<div className="col span_1_of_4 box">
			<img src="resources/img/3.jpg" alt="Ashley Greene" className="team-member"/>
			<h3>Ashley Greene</h3>
		...
		<div className="col span_1_of_4 box">
			<img src="resources/img/4.jpg" alt="ANNE HATHAWAY" className="team-member"/>
			<h3>ANNE HATHAWAY</h3>
